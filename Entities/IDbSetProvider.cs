...
namespace Apteryx.MongoDB.Driver.Extend
{
    public interface IDbSetProvider<T>
    {
        ...
        Task<T> FindOneAsync(string id, FindOptions<T, T> options = null);
        Task<T> FindOneAsync(IClientSessionHandle session, string id, FindOptions<T, T> options = null);
        Task<T> FindOneAsync(FilterDefinition<T> filter, FindOptions<T, T> options = null);
        Task<T> FindOneAsync(IClientSessionHandle session, FilterDefinition<T> filter, FindOptions<T, T> options = null);
        Task<T> FindOneAsync(Expression<Func<T, bool>> expression, FindOptions<T, T> options = null);
        Task<T> FindOneAsync(IClientSessionHandle session, Expression<Func<T, bool>> expression, FindOptions<T, T> options = null);
        Task<T> DynamicCollectionFindOneAsync<TForeign>(TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<T> DynamicCollectionFindOneAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<T> DynamicCollectionFindOneAsync<TForeign>(TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<T> DynamicCollectionFindOneAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> FindAllAsync(FindOptions<T, T> options = null);
        Task<IEnumerable<T>> FindAllAsync(IClientSessionHandle session, FindOptions<T, T> options = null);
        Task<IEnumerable<T>> DynamicCollectionFindAllAsync<TForeign>(TForeign foreignDocument, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionFindAllAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> WhereAsync(FilterDefinition<T> filter, FindOptions<T, T> options = null);
        Task<IEnumerable<T>> WhereAsync(IClientSessionHandle session, FilterDefinition<T> filter, FindOptions<T, T> options = null);
        Task<IEnumerable<T>> WhereAsync(Expression<Func<T, bool>> expression, FindOptions<T, T> options = null);
        Task<IEnumerable<T>> WhereAsync(IClientSessionHandle session, Expression<Func<T, bool>> expression, FindOptions<T, T> options = null);
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T, T> options = null) where TForeign : BaseMongoEntity;
