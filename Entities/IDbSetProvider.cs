...
namespace Apteryx.MongoDB.Driver.Extend
{
    public interface IDbSetProvider<T>
    {
        ...
        Task<IEnumerable<T>> FindAllAsync(FindOptions<T> options = null);
        Task<IEnumerable<T>> FindAllAsync(IClientSessionHandle session, FindOptions<T> options = null);
        Task<IEnumerable<T>> DynamicCollectionFindAllAsync<TForeign>(TForeign foreignDocument, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionFindAllAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> WhereAsync(FilterDefinition<T> filter, FindOptions<T> options = null);
        Task<IEnumerable<T>> WhereAsync(IClientSessionHandle session, FilterDefinition<T> filter, FindOptions<T> options = null);
        Task<IEnumerable<T>> WhereAsync(Expression<Func<T, bool>> expression, FindOptions<T> options = null);
        Task<IEnumerable<T>> WhereAsync(IClientSessionHandle session, Expression<Func<T, bool>> expression, FindOptions<T> options = null);
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
        Task<IEnumerable<T>> DynamicCollectionWhereAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
