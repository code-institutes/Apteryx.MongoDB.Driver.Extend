...
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}").CountDocuments(filter, options, cancellationToken);
//        }
...
//            where T : BaseMongoEntity
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}").CountDocuments(session, filter, options, cancellationToken);
//        }
