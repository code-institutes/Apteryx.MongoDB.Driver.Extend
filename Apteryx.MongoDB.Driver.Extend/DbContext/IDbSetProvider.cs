...
public interface IDbSetProvider<T>
{
    ...
    IFindFluent<T, T> Find(IClientSessionHandle session, FilterDefinition<T> filter, FindOptions options = null);
    IFindFluent<T, T> Find(Expression<Func<T, bool>> expression, FindOptions options = null);
    IFindFluent<T, T> Find(IClientSessionHandle session, Expression<Func<T, bool>> expression, FindOptions options = null);
    IFindFluent<T, T> DynamicCollectionFind<TForeign>(TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions options = null) where TForeign : BaseMongoEntity;
    IFindFluent<T, T> DynamicCollectionFind<TForeign>(IClientSessionHandle session, TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions options = null) where TForeign : BaseMongoEntity;
    IFindFluent<T, T> DynamicCollectionFind<TForeign>(TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions options = null) where TForeign : BaseMongoEntity;
    IFindFluent<T, T> DynamicCollectionFind<TForeign>(IClientSessionHandle session, TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions options = null) where TForeign : BaseMongoEntity;
    ...
    IAsyncEnumerable<T> FindAsync(FilterDefinition<T> filter, FindOptions<T> options = null);
    IAsyncEnumerable<T> FindAsync(IClientSessionHandle session, FilterDefinition<T> filter, FindOptions<T> options = null);
    IAsyncEnumerable<T> FindAsync(Expression<Func<T, bool>> expression, FindOptions<T> options = null);
    IAsyncEnumerable<T> FindAsync(IClientSessionHandle session, Expression<Func<T, bool>> expression, FindOptions<T> options = null);
    IAsyncEnumerable<T> DynamicCollectionFindAsync<TForeign>(TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
    IAsyncEnumerable<T> DynamicCollectionFindAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, FilterDefinition<T> filter, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
    IAsyncEnumerable<T> DynamicCollectionFindAsync<TForeign>(TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
    IAsyncEnumerable<T> DynamicCollectionFindAsync<TForeign>(IClientSessionHandle session, TForeign foreignDocument, Expression<Func<T, bool>> expression, MongoCollectionSettings settings = null, FindOptions<T> options = null) where TForeign : BaseMongoEntity;
