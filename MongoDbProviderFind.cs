...
//            where T : BaseMongoEntity
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}", settings).Find(_ => true, options).ToEnumerable();
//        }
//        /// <summary>
//        /// 查询全部
//        /// </summary>
...
//            where T : BaseMongoEntity
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}", settings).Find(session,_ => true, options).ToEnumerable();
//        }
//        /// <summary>
//        /// 查询返回集合
//        /// </summary>
...
//            where T : BaseMongoEntity
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}", settings).Find(filter, options).ToEnumerable();
//        }
//        /// <summary>
//        /// 查询返回集合
//        /// </summary>
...
//            where T : BaseMongoEntity
//        {
//            return Database.GetCollection<T>($"{foreignDocument.Id}_{_collectionName}", settings).Find(session,filter, options).ToEnumerable();
//        }
//        /// <summary>
//        /// 查询返回集合
//        /// </summary>
